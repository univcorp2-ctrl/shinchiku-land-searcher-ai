...
def test_analyze_records_ranks_better_property_first() -> None:
    records = [
        PropertyRecord(row_number=2, url="https://example.com/good", raw={"物件名": "良い物件", "価格": "9000万円", "表面利回り": "8.0%", "駅徒歩": "徒歩5分", "築年数": "築10年"}),
        PropertyRecord(row_number=3, url="https://example.com/risky", raw={"物件名": "リスク物件", "価格": "1億円", "表面利回り": "4.5%", "駅徒歩": "徒歩20分", "築年数": "築45年", "メモ": "再建築不可"}),
    ]
